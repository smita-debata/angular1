...
const GOOGLE_MAPS_API_KEY = 'AIzaSyB3Z2GcjVyvouraSnmN6tuOBlYzSZBg6j8';
...
export class LocationService {
  readonly api = this.load();
  private baseUrl = 'https://maps.googleapis.com/maps/api/geocode/json';
  private apiKey = 'AIzaSyB3Z2GcjVyvouraSnmN6tuOBlYzSZBg6j8';

  constructor(private http: HttpClient) {
  }

  forwardGeocode(latitude: number, longitude: number) {
